...
> **许可**:本工具以 **AGPL-3.0** 开源(仓库:https://github.com/twowb/znaide),自用/学习/开源衍生免费;**商用或闭源集成需商业授权**(联系见仓库 COMMERCIAL.md)。不想编译可直接下载 [GitHub Releases](https://github.com/twowb/znaide/releases) 的对应平台二进制。
